...
#define PLUGIN_GUID "{b6bbc82c-dadf-447d-94c2-c1bc274e2e76}"

/* Name of the plugin */
#define PLUGIN_NAME "Protocol Analyzer"

/* Author of the plugin */
#define PLUGIN_AUTHOR "iceman50"
...
#define PLUGIN_VERSION_STR "1.02"
